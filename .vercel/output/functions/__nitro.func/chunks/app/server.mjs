...
const _routes = [
  {
    ...
    file: "/Users/wobsoriano/tmp/nuxt-express-demo/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.13d37919.mjs').then((m) => m.default || m)
  }
];
...
const node_modules__pnpm_nuxt_643_0_0_node_modules_nuxt_dist_pages_runtime_router_mjs_36xz6bMUv3 = defineNuxtPlugin(async (nuxtApp) => {
  var _a2, _b2, _c, _d;
  let __temp, __restore;
...
const _plugins = [
  ...
  node_modules__pnpm_nuxt_643_0_0_node_modules_nuxt_dist_pages_runtime_router_mjs_36xz6bMUv3
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.22f60e7d.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
